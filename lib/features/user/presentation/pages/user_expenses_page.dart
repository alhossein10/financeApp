...
/// User Expenses Page
/// Displays ONLY the User's own expenses
/// Supports filtering by date and currency
/// Includes inline invoice preview and expense creation
/// 
/// Requirements: 15.1, 15.2, 15.3, 15.4, 15.5, 15.6, 15.7, 15.8
class UserExpensesPage extends StatefulWidget {
  const UserExpensesPage({super.key});

  @override
  State<UserExpensesPage> createState() => _UserExpensesPageState();
}

class _UserExpensesPageState extends State<UserExpensesPage> {
  // Filter state
  ...
  void _restoreFilters() {
    final dateRange = _filterService.userDateRange;
    final currencyFilter = _filterService.userCurrencyFilter;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Filter indicator
          if (_dateRange != null || _currencyFilter != null)
            Padding(
