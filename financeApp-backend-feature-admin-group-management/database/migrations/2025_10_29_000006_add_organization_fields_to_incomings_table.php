...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('incomings', function (Blueprint $table) {
            if (!Schema::hasColumn('incomings', 'organization_id')) {
                $table->unsignedBigInteger('organization_id')->after('user_id')->default(1);
                $table->index('organization_id');
            }
            
            if (!Schema::hasColumn('incomings', 'department_id')) {
